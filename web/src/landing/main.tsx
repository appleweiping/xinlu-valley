...
const ROADMAP: { zh: string; en: string; date: string; done: boolean; descZh: string; descEn: string }[] = [
  ...
  { zh: "v9 · 打磨与开放（下一个大版本）", en: "v9 · Polish & Onboarding (next)", date: "排队中", done: false, descZh: "Fable 新手引导任务链；设置面板；EN 本地化清查；README 改版（GIF+架构图）；性能巡检；五连升总结 Release。", descEn: "Fable's onboarding quest chain; settings panel; full EN localization pass; README overhaul (GIF + architecture); perf sweep; the five-release grand finale." },
];
