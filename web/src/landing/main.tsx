...
const ROADMAP: { zh: string; en: string; date: string; done: boolean; descZh: string; descEn: string }[] = [
  ...
  { zh: "v12 · 深矿与矿车（下一个大版本）", en: "v12 · Deep Mines (next)", date: "排队中", done: false, descZh: "矿洞挖到 4-6 层；过期依赖成稀有矿脉；矿车一键速返；矿灯照明半径；层底宝箱。", descEn: "Mine levels 4-6; outdated dependencies as rare veins; a minecart for the ride home; lamp-lit darkness; treasure at the bottom." },
];
