...
const ROADMAP: { zh: string; en: string; date: string; done: boolean; descZh: string; descEn: string }[] = [
  ...
  { zh: "v8 · 玩法纵深（下一个大版本）", en: "v8 · Inventory & Economy (next)", date: "排队中", done: false, descZh: "物品栏与出货箱（卖出=任务归档、清晨结算建设点）；浇水壶升级；体力条；博物馆捐赠图鉴；建设点商店买装饰摆进小镇。", descEn: "Inventory & shipping bin (sell = archive tasks, morning payouts); watering-can upgrades; stamina; museum donations; spend build points on town decorations." },
];
