...
# ---- claudeseek: tinkerer mole (rebuilt the master's tools underground) ----
SPRITES["claudeseek"] = {
    "pal": {
        "M": _rgba((104, 94, 124)),   # slate-violet fur
        "m": _rgba((132, 120, 156)),  # lighter fur
        "P": _rgba((238, 168, 156)),  # pink snout / paws
        "G": _rgba((226, 184, 92)),   # brass goggles
        "E": _rgba((40, 34, 48)),     # eyes under glass
    },
    "front": [
        "................",
        "................",
...
# ---- gemini: two-tone parrot (twin-natured newcomer) ------------------------
SPRITES["gemini"] = {
    "pal": {
        "T": _rgba((78, 188, 178)),   # teal half
        "I": _rgba((104, 116, 222)),  # indigo half
        "C": _rgba((248, 240, 222)),  # cream chest
        "B": _rgba((240, 162, 70)),   # beak / feet
        "E": _rgba((42, 36, 52)),     # eyes
    },
    "front": [
        "................",
        "................",
...
# ---- hermes: carrier pigeon (the night courier) ------------------------------
SPRITES["hermes"] = {
    "pal": {
        "G": _rgba((148, 158, 182)),  # slate feathers
        "g": _rgba((188, 196, 214)),  # light feathers
        "W": _rgba((244, 246, 250)),  # wing tips
        "N": _rgba((108, 192, 142)),  # iridescent neck
        "B": _rgba((238, 168, 84)),   # beak / feet
        "R": _rgba((206, 84, 72)),    # mail band
        "E": _rgba((42, 38, 50)),     # eyes
    },
    "front": [
        "................",
        "................",
...
# ---- opencode: beaver (the quiet workshop hand) ------------------------------
SPRITES["opencode"] = {
    "pal": {
        "B": _rgba((152, 106, 66)),   # brown fur
        "b": _rgba((184, 138, 94)),   # light fur / muzzle
        "D": _rgba((112, 78, 48)),    # dark tail
        "W": _rgba((248, 244, 232)),  # teeth
        "N": _rgba((52, 40, 36)),     # nose
        "E": _rgba((44, 38, 46)),     # eyes
    },
    "front": [
        "................",
        "................",
